...
├── Models/
│   ├── SEIRS_Models.py        # ODE definitions for v1–v9
│   ├── params.py              # Shared default parameters
│   └── __init__.py
├── Scripts/
│   ├── Model_v1_exploration/  # v1 model scripts
│   ├── Model_v2_exploration/  # v2 model scripts (NGM.py)
│   ├── Model_v3_exploration/  # v3 model scripts + Tornado_sensitivity_v3.py
│   ├── Model_v4_exploration/  # v4 single-strain scripts
│   │   ├── Simple_SEIRS_model_singlestrain.py
│   │   ├── Drug_exploration_singlestrain.py
│   │   └── Drug_exploration_singlestrain_vs_baseline.py
│   ├── Model_v5_exploration/  # v5 two-strain scripts
│   │   ├── Simple_SEIRS_model_twostrains.py
│   │   ├── Drug_exploration_twostrains_v5.py
│   │   ├── Drug_exploration_twostrains_v5_R0split.py
│   │   └── Compare_SEIRS_v4_v5.py
│   ├── Model_v6_exploration/  # v6 virulence scripts
│   │   ├── Exploration_virulence.py
│   │   └── Increase_virulence_c_contact.py
│   ├── Model_v7_exploration/  # v7 contact-restore scripts
│   │   ├── Drug_contact_restore_sweep_3D.py
│   │   ├── Drug_modifier_phi_sweep_3D.py
│   │   └── Tornado_sensitivity_v7.py
│   ├── Model_v8_exploration/  # v8 unified-restoration scripts
│   │   ├── Drug_exploration_twostrains_v8_restoration.py
│   │   ├── Drug_restoration_sweep_3D.py
│   │   └── Tornado_sensitivity_v8.py
│   └── Model_v9_exploration/  # v9 contact-penalty scripts
│       └── Drug_restoration_sweep_3D_v9.py
├── Figures/                   # Saved plots organised by model version
│   ├── Model_v1_exploration/
│   ├── Model_v2_exploration/
│   ├── Model_v3_exploration/
│   ├── Model_v4_exploration/
│   ├── Model_v5_exploration/
│   ├── Model_v6_exploration/
│   ├── Model_v7_exploration/
│   │   ├── drug_contact_restore_sweep/
│   │   └── drug_modifier_phi_sweep/
│   ├── Model_v8_exploration/
│   │   └── drug_restoration_sweep/
│   └── Model_v9_exploration/
│       └── drug_restoration_sweep_v9/
├── Tables/                    # Saved CSV summaries (generated by scripts)
├── Outputs/                   # Tornado sensitivity CSV outputs
...
#### `Scripts/Model_v4_exploration/Simple_SEIRS_model_singlestrain.py`
...
```bash
python Scripts/Model_v4_exploration/Simple_SEIRS_model_singlestrain.py
```

Output: `Figures/Model_v4_exploration/singlestrain_v4_drug_comparison.png`

#### `Scripts/Model_v5_exploration/Simple_SEIRS_model_twostrains.py`
Two-strain (high/low virulence) v5 demo producing a side-by-side comparison
figure.

```bash
python Scripts/Model_v5_exploration/Simple_SEIRS_model_twostrains.py
```
...
#### `Scripts/Model_v4_exploration/Drug_exploration_singlestrain.py` (Model v4)
...
```bash
python Scripts/Model_v4_exploration/Drug_exploration_singlestrain.py
```

Output: `Figures/Model_v4_exploration/Explore_v4_singlestrain.png`

#### `Scripts/Model_v4_exploration/Drug_exploration_singlestrain_vs_baseline.py`
Compares the v4 single-strain drug scenario against the no-drug baseline
with a detailed four-panel figure.

```bash
python Scripts/Model_v4_exploration/Drug_exploration_singlestrain_vs_baseline.py
```

Output: `Figures/Model_v4_exploration/Explore_v4_singlestrain_vs_baseline.png`

#### `Scripts/Model_v5_exploration/Drug_exploration_twostrains_v5.py` (Model v5)
Two-strain sweep producing three heatmaps (peak infections, epidemic size,
dominant R0 across both strains).

```bash
python Scripts/Model_v5_exploration/Drug_exploration_twostrains_v5.py
```

Output: `Figures/Model_v5_exploration/Explore_v5_twostrains.png`

#### `Scripts/Model_v5_exploration/Drug_exploration_twostrains_v5_R0split.py`
Same as above but splits the effective R0 heatmap by strain.

```bash
python Scripts/Model_v5_exploration/Drug_exploration_twostrains_v5_R0split.py
```

Output: `Figures/Model_v5_exploration/Explore_v5_twostrains_R0split_vs_baseline.png`

#### `Scripts/Model_v7_exploration/Drug_modifier_phi_sweep_3D.py`
...
```bash
python Scripts/Model_v7_exploration/Drug_modifier_phi_sweep_3D.py \
...
Output: `Figures/Model_v7_exploration/drug_modifier_phi_sweep/peak_infection_landscape.png`

---

### Model comparison

#### `Scripts/Model_v5_exploration/Compare_SEIRS_v4_v5.py`
Runs both v4 and v5 under baseline and drug conditions, prints metrics, and
saves a combined comparison figure.

```bash
python Scripts/Model_v5_exploration/Compare_SEIRS_v4_v5.py
```

Output: `Figures/Model_v5_exploration/combined_v4_v5_comparison.png`

---

### Virulence exploration

#### `Scripts/Model_v6_exploration/Exploration_virulence.py`
...
```bash
python Scripts/Model_v6_exploration/Exploration_virulence.py
```

Output: `Figures/Model_v6_exploration/virulence_v6_I_timeseries.png`

#### `Scripts/Model_v6_exploration/Increase_virulence_c_contact.py`
Explores the effect of increasing high-strain contact rate (c_high) on
epidemic outcomes, producing a multi-panel figure.

```bash
python Scripts/Model_v6_exploration/Increase_virulence_c_contact.py
```

Output: `Figures/Model_v6_exploration/increase_virulence_c_contact_extreme.png`

---

### Sensitivity analysis

#### `Scripts/Model_v3_exploration/Tornado_sensitivity_v3.py`
...
```bash
python Scripts/Model_v3_exploration/Tornado_sensitivity_v3.py
```

Output: `Figures/Model_v3_exploration/Tornado_v3_peak_I.png`

#### `Scripts/Model_v7_exploration/Tornado_sensitivity_v7.py`
Same analysis for Model v7, which includes the `drug_contact_restore`
parameter and dynamic high-strain contact rates.

```bash
python Scripts/Model_v7_exploration/Tornado_sensitivity_v7.py
```

Output: `Figures/Model_v7_exploration/Tornado_v7_peak_I.png`

#### `Scripts/Model_v8_exploration/Tornado_sensitivity_v8.py`
Tornado sensitivity for Model v8, which uses the unified restoration mechanism.

```bash
python Scripts/Model_v8_exploration/Tornado_sensitivity_v8.py
```

Output: `Figures/Model_v8_exploration/Tornado_v8_peak_I.png`

---

### Next Generation Matrix

#### `Scripts/Model_v2_exploration/NGM.py`
Computes the Next Generation Matrix (NGM) and the basic reproduction number
R0 analytically for Model v2.

```bash
python Scripts/Model_v2_exploration/NGM.py
```
...
Generated figures are saved under `Figures/`, organised into subfolders by model version.  A selection:

| File | Script | Description |
|------|--------|-------------|
| `Model_v4_exploration/Explore_v4_singlestrain_vs_baseline.png` | `Drug_exploration_singlestrain_vs_baseline.py` | v4 heatmaps |
| `Model_v5_exploration/Explore_v5_twostrains.png` | `Drug_exploration_twostrains_v5.py` | v5 heatmaps |
| `Model_v5_exploration/Explore_v5_twostrains_R0split_vs_baseline.png` | `Drug_exploration_twostrains_v5_R0split.py` | v5 R0 by strain |
| `Model_v5_exploration/combined_v4_v5_comparison.png` | `Compare_SEIRS_v4_v5.py` | v4 vs v5 side-by-side |
| `Model_v7_exploration/Tornado_v7_peak_I.png` | `Tornado_sensitivity_v7.py` | Sensitivity ranking |
| `Model_v6_exploration/increase_virulence_c_contact_extreme.png` | `Increase_virulence_c_contact.py` | Virulence scenarios |
| `Model_v7_exploration/drug_modifier_phi_sweep/` | `Drug_modifier_phi_sweep_3D.py` | 3-D landscapes |
