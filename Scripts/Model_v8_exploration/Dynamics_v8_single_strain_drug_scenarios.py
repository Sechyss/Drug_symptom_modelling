"""
Dynamics comparison for SEIRS v8 (single-strain) under two intervention setups.
...
# %% Baseline parameters for v8 single-strain
...
def pack_params(m_r_drug, theta):
    """Build parameter tuple with the v8 single-strain expected order."""
    return (
        c_low,
        r_low,
        phi_t,
...
def run_scenario(name, params_tuple):
    ...
    sol = odeint(SEIRS_model_v8_singlestrain, init, T, args=(params_tuple,))
...
# %% Print metrics
print("=== v8 Single-Strain Dynamics Comparison ===")
...
out_base = os.path.join(
    ...
    "../../Figures/Model_v8_exploration/v8_single_strain_dynamics_publication",
)
