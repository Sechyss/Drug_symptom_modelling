"""
Figure 1 for SEIRS v8 (two-strain): final epidemic size under four intervention setups.
...
The script computes final epidemic size split by virulence and saves Fig1.
"""
...
def run_scenario(name, params_tuple):
    """Run ODE and return summary metrics for final epidemic size split."""
...
# %% Print metrics
print("=== v8 Two-Strain Final Epidemic Size (Figure 1) ===")
for m in results:
    print(f"\n{m['scenario']}")
...
out_base = os.path.join(
    ...
    "../../Figures/Model_v8_exploration/FigS1",
)
