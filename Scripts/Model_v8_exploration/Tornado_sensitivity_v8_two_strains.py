...
# Parameter keys for v8 two-strain tornado analysis
...
def create_tornado_plot(rows, metric_name, output_suffix=""):
    ...
    fig_path = os.path.join(out_dir, f"Tornado_v8_{metric_name}{output_suffix}.svg")
...
print("=" * 60)
print("TORNADO SENSITIVITY ANALYSIS - SEIRS Model v8 Two Strains")
print("=" * 60)
