...
ax.set_title(f"Tornado sensitivity (SEIRS_model_v7) — metric: {metric_label}")
...
fig_path = os.path.join(out_dir, f"Tornado_v7_{METRIC}.png")
...
csv_path = os.path.join(csv_dir, f"Tornado_v7_{METRIC}.csv")
...
print("\n" + "="*60)
print("PARAMETER SENSITIVITY SUMMARY (sorted by influence)")
print("="*60)
