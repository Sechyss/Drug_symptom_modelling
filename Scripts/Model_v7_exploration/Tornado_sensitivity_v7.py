...
def create_tornado_plot(rows, metric_name, output_suffix=""):
    ...
    # Save figure
    out_dir = os.path.join(ROOT_DIR, "Figures", "Model_v7_exploration")
...
if STRAIN_COMPARISON and METRIC == "peak_I":
    ...
    comparison_path = os.path.join(ROOT_DIR, "Figures", "Model_v7_exploration", "Tornado_v7_strain_comparison.png")
