...
def create_tornado_plot(rows, output_suffix=""):
    ...
    fig_path = os.path.join(out_dir, f"Tornado_v9_relative_peak_gap{output_suffix}.svg")
...
def save_csv_results(rows, output_suffix=""):
    ...
    csv_path = os.path.join(csv_dir, f"Tornado_v9_relative_peak_gap{output_suffix}.csv")
...
print("=" * 70)
print("TORNADO SENSITIVITY - SEIRS Model v9 Two Strains")
